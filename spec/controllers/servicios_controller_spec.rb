  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved servicio as @servicio" do
        ...
        post :create, {:servicio => { "titulo" => "invalid value" }}, valid_session
        assigns(:servicio).should be_a_new(Servicio)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested servicio" do
        ...
        Servicio.any_instance.should_receive(:update_attributes).with({ "titulo" => "MyString" })
        put :update, {:id => servicio.to_param, :servicio => { "titulo" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the servicio as @servicio" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Servicio.any_instance.stub(:save).and_return(false)
        put :update, {:id => servicio.to_param, :servicio => { "titulo" => "invalid value" }}, valid_session
        assigns(:servicio).should eq(servicio)
      end
